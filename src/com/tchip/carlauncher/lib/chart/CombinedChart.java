...
import com.tchip.carlauncher.lib.chart.CombinedChartRenderer;
import com.tchip.carlauncher.lib.chart.CombinedData;
 ...
 */
public class CombinedChart extends BarLineChartBase<CombinedData> implements
		LineDataProvider, BarDataProvider, ScatterDataProvider,
		CandleDataProvider, BubbleDataProvider {
	...
	protected DrawOrder[] mDrawOrder = new DrawOrder[] { DrawOrder.BAR,
			DrawOrder.BUBBLE, DrawOrder.LINE, DrawOrder.CANDLE,
			DrawOrder.SCATTER };
