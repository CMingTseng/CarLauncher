...
public class CardPreviewer extends AsyncTask<File, Void, Bitmap>
{
	...
	{
		this.imageView = imageView;
		if (imageView != null) imageView.setImageResource(R.drawable.file_card_image_placeholder);
	}
	...
	protected void onPostExecute(Bitmap result)
	{
		...
		if (result == null)
		{
			if (imageView != null) imageView.setImageResource(R.drawable.file_card_image_error);
		}
		else
		{
			thumbCache.put(file, result);
