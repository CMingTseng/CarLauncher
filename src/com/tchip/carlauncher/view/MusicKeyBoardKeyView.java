 ...
 * 自定义搜索页的键盘
 */
public class MusicKeyBoardKeyView extends ImageView {
	...
	public MusicKeyBoardKeyView(Context context) {
		super(context);
		init(context);
	}

	public MusicKeyBoardKeyView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public MusicKeyBoardKeyView(Context context, AttributeSet attrs, int defStyle) {
