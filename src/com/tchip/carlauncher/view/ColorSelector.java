...
import com.tchip.carlauncher.view.NumberSeekBar.OnValueChangedListener;
...
public class ColorSelector extends android.app.Dialog implements OnValueChangedListener{
	...
	@Override
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    // Configure Sliders
	    red = (NumberSeekBar) findViewById(R.id.red);
	    green = (NumberSeekBar) findViewById(R.id.green);
	    blue = (NumberSeekBar) findViewById(R.id.blue);
