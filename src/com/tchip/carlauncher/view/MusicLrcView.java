...
import com.tchip.carlauncher.model.MusicLyricModel;
import com.tchip.carlauncher.model.MusicSentenceModel;

public class MusicLrcView extends ScrollView {

	private MusicLyricModel lyricModel;
	private List<MusicSentenceModel> list;
	...
	public void setLyric(MusicLyricModel model) {
		...
		for (MusicSentenceModel sentence : this.list) {
	...
	public void updateIndex(long time) {
		...
		if (index != t) {
			...
			mScroller.startScroll(this.getScrollX(), (int) (oldHeight
					+ fontSize - midHeight + DY / 2), 0, 30, 800);
