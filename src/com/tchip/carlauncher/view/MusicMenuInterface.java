...
public interface MusicMenuInterface {

	public abstract void scrollBehindTo(int x, int y, MusicCustomViewBehind cvb,
			float scrollScale);

	public abstract int getMenuLeft(MusicCustomViewBehind cvb, View content);

	public abstract int getAbsLeftBound(MusicCustomViewBehind cvb, View content);

	public abstract int getAbsRightBound(MusicCustomViewBehind cvb, View content);
	...
	public abstract void drawFade(Canvas canvas, int alpha,
			MusicCustomViewBehind cvb, View content);
