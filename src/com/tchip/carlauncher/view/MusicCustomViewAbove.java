...
import com.tchip.carlauncher.view.SlidingMenu.OnClosedListener;
import com.tchip.carlauncher.view.SlidingMenu.OnOpenedListener;

public class MusicCustomViewAbove extends ViewGroup {
	...
	private MusicCustomViewBehind mViewBehind;
	// private int mMode;
	...
	public MusicCustomViewAbove(Context context) {
		this(context, null);
	}

	public MusicCustomViewAbove(Context context, AttributeSet attrs) {
		super(context, attrs);
		initCustomViewAbove();
	}
	...
	public void setCustomViewBehind(MusicCustomViewBehind cvb) {
		mViewBehind = cvb;
	}
