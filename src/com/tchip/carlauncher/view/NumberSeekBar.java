...
public class NumberSeekBar extends CustomView {
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        setMinimumWidth(MaterialUtil.dpToPx(80, getResources()));
        ...
        RelativeLayout.LayoutParams params = new LayoutParams(MaterialUtil.dpToPx(20,
                getResources()), MaterialUtil.dpToPx(20, getResources()));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (value == min) {
            ...
            paint.setStrokeWidth(MaterialUtil.dpToPx(2, getResources()));
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN
                ...
                if ((event.getX() <= getWidth() && event.getX() >= 0)) {
                    ...
                    if (numberIndicator != null) {
                        ...
                        numberIndicator.indicator.finalY = MaterialUtil
    ...
    class Indicator extends RelativeLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (animate) {
                ...
                y -= MaterialUtil.dpToPx(6, getResources());
                size += MaterialUtil.dpToPx(2, getResources());
            }
            canvas.drawCircle(
                    ViewHelper.getX(ball)
                            + MaterialUtil.getRelativeLeft((View) ball.getParent())
            ...
            if (animate == false) {
                ViewHelper
                        .setX(numberIndicator.numberIndicator,
                                (ViewHelper.getX(ball)
                                        + MaterialUtil.getRelativeLeft((View) ball
