...
import com.tchip.carlauncher.view.SlidingMenu.CanvasTransformer;

public class MusicCustomViewBehind extends ViewGroup {
	...
	private MusicCustomViewAbove mViewAbove;
	...
	public MusicCustomViewBehind(Context context) {
		this(context, null);
	}

	public MusicCustomViewBehind(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void setCustomViewAbove(MusicCustomViewAbove customViewAbove) {
