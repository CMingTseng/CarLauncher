...
public class MusicLyricModel implements Serializable {
	private static final long serialVersionUID = 1316511579773918698L;
	private List<MusicSentenceModel> sentenceList;

	public MusicLyricModel(List<MusicSentenceModel> list) {
		this.sentenceList = list;
	}

	public List<MusicSentenceModel> getSentenceList() {
		return sentenceList;
	}
