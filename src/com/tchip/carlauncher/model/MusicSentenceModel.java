...
public class MusicSentenceModel implements Serializable {
	...
	public MusicSentenceModel(String content, long fromTime, long toTime) {
		this.content = content;
		this.fromTime = fromTime;
		this.toTime = toTime;
	}

	public MusicSentenceModel(String content, long fromTime) {
		this(content, fromTime, 0);
	}

	public MusicSentenceModel(String content) {
		this(content, 0, 0);
	}
