 ...
 * 监听手机甩动
 */
public class MusicShakeDetector implements SensorEventListener {
	...
	public MusicShakeDetector(Context context) {
		// 获取传感器管理服务
	...
	public void start() {
		...
		boolean success = mSensorManager.registerListener(this,
