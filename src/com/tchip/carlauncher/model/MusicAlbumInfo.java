...
public class MusicAlbumInfo implements Parcelable {
	...
	public static final Parcelable.Creator<MusicAlbumInfo> CREATOR = new Parcelable.Creator<MusicAlbumInfo>() {
		...
		@Override
		public MusicAlbumInfo[] newArray(int size) {
			return new MusicAlbumInfo[size];
		}
	};
