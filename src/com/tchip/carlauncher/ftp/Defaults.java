...
public class Defaults {
	...
	protected static int consoleLogLevel = Defaults.release ? Log.INFO
			: Log.DEBUG;
	...
	public static final String chrootDir = Environment
			.getExternalStorageDirectory().getPath();
	public static final boolean acceptWifi = true;
	public static final boolean acceptNet = false; // don't incur bandwidth
													// charges
	...
	// Try to fix the transfer stall bug, reopen the destination file
	// periodically
