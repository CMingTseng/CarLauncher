 ...
 * 引导页图片，停留若干秒，然后自动消失。
 */
public class MusicSplashScreen {
	...
	public MusicSplashScreen(Activity activity) {
	 ...
	 *            停留时间，以毫秒为单位。
	 * @param animation
	 *            消失时的动画效果，取值可以是：SplashScreen.SLIDE_LEFT, SplashScreen.SLIDE_UP,
	 *            SplashScreen.FADE
	 */
