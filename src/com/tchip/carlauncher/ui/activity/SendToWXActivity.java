...
public class SendToWXActivity extends Activity {
		...
		findViewById(R.id.send_text).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						WeChatMMAlert.showAlert(SendToWXActivity.this, "send text",
									...
									public void onClick(int whichButton) {
										...
										case MMAlertSelect2: {
											...
											final String path = SDCARD_ROOT
													+ "/test.png";
											appdata.fileData = WeChatUtil
													.readFromFile(path, 0, -1);
											appdata.extInfo = "this is ext info";

											final WXMediaMessage msg = new WXMediaMessage();
											msg.setThumbImage(WeChatUtil
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case 0x101: {
			...
			final WXMediaMessage msg = new WXMediaMessage();
			msg.setThumbImage(WeChatUtil.extractThumbNail(path, 150, 150, true));
			msg.title = "this is title";
			msg.description = "this is description";
			msg.mediaObject = appdata;
