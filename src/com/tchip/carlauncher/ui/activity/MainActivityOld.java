	...
	class MyOnClickListener implements View.OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.imgMultimedia:
				Intent intent11 = new Intent(MainActivityOld.this,
			...
			case R.id.imgBluetooth:
				Intent intent13 = new Intent(MainActivityOld.this,
						BluetoothActivity.class);
				startActivity(intent13);

				break;
			case R.id.imgRoute:
				Intent intent14 = new Intent(MainActivityOld.this,
						RouteListActivity.class);
				startActivity(intent14);
				break;
			case R.id.imgWeather:
				Intent intent15 = new Intent(MainActivityOld.this,
						WeatherActivity.class);
				startActivity(intent15);
				break;
			case R.id.imgFileExplorer:
				Intent intent16 = new Intent(MainActivityOld.this,
						FileRemoteControlActivity.class);
				startActivity(intent16);
				break;
			// Vice Layout
			case R.id.imgNear:
				Intent intent21 = new Intent(MainActivityOld.this,
						NearActivity.class);
			...
			case R.id.imgRoutePlan:
				Intent intent22 = new Intent(MainActivityOld.this,
				...
				break;
			case R.id.imgAbout:
				Intent intent23 = new Intent(MainActivityOld.this,
						AboutActivity.class);
				...
				break;
			case R.id.imgChat:
				Intent intent24 = new Intent(MainActivityOld.this,
						ChatActivity.class);
			...
			case R.id.imgSetting:
				Intent intent25 = new Intent(MainActivityOld.this,
