...
import com.tchip.carlauncher.view.MusicKeyBoardKeyView;

/**
 * 歌曲搜索界面
 */
public class MusicListSearchActivity extends Activity implements
		OnClickListener, Constant, OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAnimIn = AnimationUtils.loadAnimation(this,
				R.anim.music_push_bottom_in);
		mAnimOut = AnimationUtils.loadAnimation(this,
				R.anim.music_push_bottom_out);
	...
	private void initConnection() {
		...
		Intent intent = new Intent(
				"com.tchip.carlauncher.music.service.MusicMediaService");
	...
	private void initView() {
		...
		MusicKeyBoardKeyView key2 = (MusicKeyBoardKeyView) findViewById(R.id.t9_key_2);
		MusicKeyBoardKeyView key3 = (MusicKeyBoardKeyView) findViewById(R.id.t9_key_3);
		MusicKeyBoardKeyView key4 = (MusicKeyBoardKeyView) findViewById(R.id.t9_key_4);
		MusicKeyBoardKeyView key5 = (MusicKeyBoardKeyView) findViewById(R.id.t9_key_5);
		MusicKeyBoardKeyView key6 = (MusicKeyBoardKeyView) findViewById(R.id.t9_key_6);
		MusicKeyBoardKeyView key7 = (MusicKeyBoardKeyView) findViewById(R.id.t9_key_7);
		MusicKeyBoardKeyView key8 = (MusicKeyBoardKeyView) findViewById(R.id.t9_key_8);
		MusicKeyBoardKeyView key9 = (MusicKeyBoardKeyView) findViewById(R.id.t9_key_9);
		key2.init("ABC");
		key3.init("DEF");
		key4.init("GHI");
		key5.init("JKL");
		...
		mSearchInputEt.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence s, int start, int before,
				...
				if (TextUtils.isEmpty(s)) {
					...
					// 普通的模糊搜索
					pinyinSearch(MusicStringHelper.getPingYin(s.toString()));
				}
			}
			...
			public void afterTextChanged(Editable s) {
				try {
					...
					/*
					 * else { mAdapter.setPlayState(mService.getPlayState(), 0);
					 * }
					 */
				} catch (Exception e) {
					e.printStackTrace();
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				convertView = getLayoutInflater().inflate(
						R.layout.music_searchlist_item, null);
	...
	private boolean contains(String regexp, String key, String input) {
		...
		if (input.length() < 6) {
			// 根据首字母进行模糊查询
			String p = regexp.toUpperCase(Locale.CHINA)
					.replace("-", "[*+a-z]*");
