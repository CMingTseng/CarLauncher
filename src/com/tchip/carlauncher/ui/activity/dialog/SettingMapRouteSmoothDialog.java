...
public class SettingMapRouteSmoothDialog extends android.app.Dialog {
	...
	private RadioGroup routeSmoothGroup;
	private RadioButton routeSmoothOn, routeSmoothOff;
	private SharedPreferences sharedPreferences;
	private Editor editor;

	public SettingMapRouteSmoothDialog(Context context) {
		super(context, android.R.style.Theme_Translucent);
		this.context = context;
	}

	public SettingMapRouteSmoothDialog(Context context, String title,
			String message) {
		super(context, android.R.style.Theme_Translucent);
	...
	private void iniRadioGroup() {
		...
		routeSmoothGroup = (RadioGroup) findViewById(R.id.routeSmoothGroup);
		routeSmoothGroup
				.setOnCheckedChangeListener(new MyRadioOnCheckedListener());
		routeSmoothOn = (RadioButton) findViewById(R.id.routeSmoothOn);
		routeSmoothOff = (RadioButton) findViewById(R.id.routeSmoothOff);
		boolean recordRouteConfig = sharedPreferences.getBoolean("routeSmooth",
				true);
		if (!recordRouteConfig) {
			routeSmoothOff.setChecked(true);
		} else {
			routeSmoothOn.setChecked(true);
		}
	}
	...
	class MyRadioOnCheckedListener implements OnCheckedChangeListener {
		...
		public void onCheckedChanged(RadioGroup group, int checkedId) {
			...
			case R.id.routeSmoothOff:
				editor.putBoolean("routeSmooth", false);

				break;
			case R.id.routeSmoothOn:
			default:
				editor.putBoolean("routeSmooth", true);
				break;
			}
			editor.commit();
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dialog_setting_map_route_smooth);
		...
		anim.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				view.post(new Runnable() {
					@Override
					public void run() {
						SettingMapRouteSmoothDialog.super.dismiss();
					}
				});
