package com.tchip.carlauncher.ui.activity.dialog;
...
public class SettingMapNavigationDialog extends android.app.Dialog {
	...
	private RadioButton navigationBaidu, navigationGaode;
	private SharedPreferences sharedPreferences;
	private Editor editor;

	public SettingMapNavigationDialog(Context context) {
		super(context, android.R.style.Theme_Translucent);
		this.context = context;
	}

	public SettingMapNavigationDialog(Context context, String title,
			String message) {
		super(context, android.R.style.Theme_Translucent);
	...
	private void iniRadioGroup() {
		...
		navigationGroup = (RadioGroup) findViewById(R.id.navigationGroup);
		navigationGroup
				.setOnCheckedChangeListener(new MyRadioOnCheckedListener());
		navigationBaidu = (RadioButton) findViewById(R.id.navigationBaidu);
		navigationGaode = (RadioButton) findViewById(R.id.navigationGaode);
		String navigationConfig = sharedPreferences.getString("defaultNavi",
				"BAIDU");
		if ("GAODE".equals(navigationConfig)) {
			navigationGaode.setChecked(true);
		} else {
			navigationBaidu.setChecked(true);
		}
	}
	...
	class MyRadioOnCheckedListener implements OnCheckedChangeListener {
		...
		public void onCheckedChanged(RadioGroup group, int checkedId) {
			...
			case R.id.navigationGaode:
				editor.putString("defaultNavi", "GAODE");

				break;
			case R.id.navigationBaidu:
			default:
				editor.putString("defaultNavi", "BAIDU");
				break;
			}
			editor.commit();
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dialog_setting_map_navigation);
		...
		anim.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				view.post(new Runnable() {
					@Override
					public void run() {
						SettingMapNavigationDialog.super.dismiss();
					}
				});
