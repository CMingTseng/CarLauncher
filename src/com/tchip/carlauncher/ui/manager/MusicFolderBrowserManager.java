 ...
 * 文件夹列表
 */
public class MusicFolderBrowserManager extends MusicMainUIManager implements
		Constant, OnItemClickListener, OnClickListener {
	...
	private List<MusicFolderInfo> list = new ArrayList<MusicFolderInfo>();
	...
	public MusicFolderBrowserManager(Activity activity, MusicUIManager manager) {
	...
	public View getView() {
		View folderView = mInflater.inflate(R.layout.music_folderbrower, null);
		initBg(folderView);
		initView(folderView);
		return folderView;
	}
	...
	private class MyAdapter extends BaseAdapter {
		...
		@Override
		public MusicFolderInfo getItem(int position) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			MusicFolderInfo folder = getItem(position);
			ViewHolder viewHolder;
			if (convertView == null) {
				viewHolder = new ViewHolder();
				convertView = mActivity.getLayoutInflater().inflate(
						R.layout.music_folderbrower_listitem, null);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
			long id) {
		mUIManager.setContentType(Constant.Music.FOLDER_TO_MYMUSIC,
