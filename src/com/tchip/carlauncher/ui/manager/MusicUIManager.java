...
import com.tchip.carlauncher.ui.activity.MusicMainContentActivity.OnBackListener;

/**
 * 动态生成view并通过viewPager来显示
 */
public class MusicUIManager implements Constant, OnBackListener {
	...
	private MusicMainUIManager mMainUIManager;

	// private SPStorage mSp;
	// private String mDefaultBgPath;

	public MusicUIManager(Activity activity, View view) {
		this.mActivity = activity;
		this.mView = view;
		mMainActivity = (MusicMainContentActivity) activity;
	...
	private class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageScrollStateChanged(int arg0) {
			...
			if (onPageScrolled == 0 && arg0 == 0) {
				mMainActivity.unRegisterBackListener(MusicUIManager.this);
				mViewPager.removeAllViews();
