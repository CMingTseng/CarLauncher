...
import com.tchip.carlauncher.ui.activity.MusicListSearchActivity;
import com.tchip.carlauncher.ui.activity.MusicMainContentActivity;
import com.tchip.carlauncher.util.MusicUtils;
import com.tchip.carlauncher.view.MusicAlwaysMarqueeTextView;

/**
 * 处理歌曲列表页中的UI元素，包括底部view，SlidingDrawer等
 */
@SuppressLint("HandlerLeak")
public class MusicMyUIManager implements OnClickListener, Constant {

	private Activity mActivity;
	private View mView;
	private MusicServiceManager mServiceManager;
	private MusicAlwaysMarqueeTextView mMusicNameTv, mArtistTv;
	...
	public MusicMyUIManager(Activity a, MusicServiceManager sm, View view,
			MusicUIManager manager) {
		this.mActivity = a;
		this.mView = view;
	...
	public void onClick(View v) {
		...
		case R.id.imageBack:
			...
			break;
		case R.id.btn_menu2:
			((MusicMainContentActivity) mActivity).mSlidingMenu.showMenu(true);
			break;
		}
	}
}
