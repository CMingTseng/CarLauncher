...
public class FileRemoteControlActivity extends Activity {
	...
	public void updateUi() {
		...
		wifiImg.setImageResource(isWifiReady ? R.drawable.file_wifi_state4
				: R.drawable.file_wifi_state0);
		...
		if (isWifiReady) {
			...
			startStopButtonText.setCompoundDrawablesWithIntrinsicBounds(
					running ? R.drawable.file_disconnect
							: R.drawable.file_connect, 0, 0, 0);
