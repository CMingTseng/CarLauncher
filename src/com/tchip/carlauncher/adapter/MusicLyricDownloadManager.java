 ...
 * 歌词下载
 */
public class MusicLyricDownloadManager {
	private static final String TAG = MusicLyricDownloadManager.class
			.getSimpleName();
	public static final String GB2312 = "GB2312";
	public static final String UTF_8 = "utf-8";
	private final int mTimeOut = 10 * 1000;
	private MusicLyricXMLParser mLyricXMLParser = new MusicLyricXMLParser();
	private URL mUrl = null;
	private int mDownloadLyricId = -1;

	// private Context mContext = null;

	public MusicLyricDownloadManager(Context c) {
		// mContext = c;
	}
