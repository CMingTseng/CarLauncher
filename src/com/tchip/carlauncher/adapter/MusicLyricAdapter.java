...
public class MusicLyricAdapter extends BaseAdapter {
	private static final String TAG = MusicLyricAdapter.class.getSimpleName();

	/** 歌词句子集合 */
	List<MusicLyricSentence> mLyricSentences = null;
	...
	public MusicLyricAdapter(Context context) {
		mContext = context;
		mLyricSentences = new ArrayList<MusicLyricSentence>();
		mIndexOfCurrentSentence = 0;
	}

	/** 设置歌词，由外部调用， */
	public void setLyric(List<MusicLyricSentence> lyric) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.music_lyric_line, null);
