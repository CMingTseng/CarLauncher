 ...
 * 业务bean
 */
public class OLMusicFileService {
	private OLMusicDBOpenHelper openHelper;

	public OLMusicFileService(Context context) {
		openHelper = new OLMusicDBOpenHelper(context);
	}
