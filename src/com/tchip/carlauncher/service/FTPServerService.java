...
import com.tchip.carlauncher.lib.ftp.ProxyConnector;
import com.tchip.carlauncher.lib.ftp.SessionThread;
import com.tchip.carlauncher.lib.ftp.TcpListener;
import com.tchip.carlauncher.lib.ftp.UiUpdater;
import com.tchip.carlauncher.lib.ftp.Util;
...
public class FTPServerService extends Service implements Runnable {
	...
	protected static MyLog staticLog = new MyLog(
			FTPServerService.class.getName());
	...
	private void setupNotification() {
		...
		int icon = R.drawable.file_notification;
		...
		if (address != null) {
			...
			contentText = "ftp://" + address.getHostAddress()
				...
				if (proxyConnector != null) {
					if (!proxyConnector.isAlive()) {
						...
						if (nowMillis - proxyStartMillis < 3000) {
							...
							// failure.
							myLog.l(Log.DEBUG,
									"Incrementing proxy start failures");
