 ...
 * 
 */
public class MusicMediaService extends Service implements Constant,
		OnShakeListener {

	private static final String PAUSE_BROADCAST_NAME = "com.tchip.carlauncher.music.pause.broadcast";
	private static final String NEXT_BROADCAST_NAME = "com.tchip.carlauncher.music.next.broadcast";
	private static final String PRE_BROADCAST_NAME = "com.tchip.carlauncher.music.pre.broadcast";
	...
	private MusicShakeDetector mShakeDetector;
	/** 当前是否正在播放 */
	...
	public void onCreate() {
		...
		mSp = new MusicSPStorage(this);
		mShakeDetector = new MusicShakeDetector(this);
	...
	private class ServerStub extends IMediaService.Stub {
		...
		public void updateNotification(Bitmap bitmap, String title, String name)
				throws RemoteException {
			MusicMediaService.this.updateNotification(bitmap, title, name);
		}

		@Override
		public void cancelNotification() throws RemoteException {
			MusicMediaService.this.cancelNotification();
		}
