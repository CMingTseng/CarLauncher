...
public interface OnDrawListener {
	...
	/**
	 * Called whenever an entry is added with the finger. Note this is also
	 * called for entries that are generated by the library, when the touch
	 * gesture is too fast and skips points.
	 * 
	 * @param entry
