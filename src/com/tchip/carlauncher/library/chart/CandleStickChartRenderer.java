...
import com.tchip.carlauncher.library.chart.CandleBodyBuffer;
import com.tchip.carlauncher.library.chart.CandleShadowBuffer;
import com.tchip.carlauncher.library.chart.CandleData;
import com.tchip.carlauncher.library.chart.CandleDataSet;
import com.tchip.carlauncher.library.chart.CandleEntry;
import com.tchip.carlauncher.library.chart.Entry;
import com.tchip.carlauncher.library.chart.CandleDataProvider;
import com.tchip.carlauncher.library.chart.ColorTemplate;
...
public class CandleStickChartRenderer extends DataRenderer {
	...
	public CandleStickChartRenderer(CandleDataProvider chart,
	...
	public void drawHighlighted(Canvas c, Highlight[] indices) {
		...
		for (int i = 0; i < indices.length; i++) {
			...
			float[] vertPts = new float[] { xIndex - 0.5f, max, xIndex - 0.5f,
					min, xIndex + 0.5f, max, xIndex + 0.5f, min };

			float[] horPts = new float[] { mChart.getXChartMin(), low,
					mChart.getXChartMax(), low, mChart.getXChartMin(), high,
					mChart.getXChartMax(), high };
