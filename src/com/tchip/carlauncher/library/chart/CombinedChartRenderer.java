...
import com.tchip.carlauncher.library.chart.CombinedChart;
import com.tchip.carlauncher.library.chart.CombinedChart.DrawOrder;
...
public class CombinedChartRenderer extends DataRenderer {
		...
		for (DrawOrder order : orders) {
			...
			case BAR:
				if (chart.getBarData() != null)
					mRenderers.add(new BarChartRenderer(chart, animator,
							viewPortHandler));
				break;

			case BUBBLE:
				if (chart.getBubbleData() != null)
					mRenderers.add(new BubbleChartRenderer(chart, animator,
							viewPortHandler));
				break;
			case LINE:
				if (chart.getLineData() != null)
					mRenderers.add(new LineChartRenderer(chart, animator,
							viewPortHandler));
				break;
			case CANDLE:
				if (chart.getCandleData() != null)
					mRenderers.add(new CandleStickChartRenderer(chart,
							animator, viewPortHandler));
				break;
			case SCATTER:
				if (chart.getScatterData() != null)
					mRenderers.add(new ScatterChartRenderer(chart, animator,
							viewPortHandler));
				break;
			}
		}
	...
	@Override
	public void calcXBounds(BarLineScatterCandleDataProvider chart,
			int xAxisModulus) {
		for (DataRenderer renderer : mRenderers)
