...
import com.tchip.carlauncher.library.chart.RadarChartRenderer;
import com.tchip.carlauncher.library.chart.XAxisRendererRadarChart;
import com.tchip.carlauncher.library.chart.YAxisRendererRadarChart;
...
public class RadarChart extends PieRadarChartBase<RadarData> {
	...
	protected void init() {
		...
		mYAxisRenderer = new YAxisRendererRadarChart(mViewPortHandler, mYAxis,
				this);
		mXAxisRenderer = new XAxisRendererRadarChart(mViewPortHandler, mXAxis,
				this);
	}
	...
	protected void calcMinMax() {
		...
		float leftRange = Math.abs(maxLeft
				- (mYAxis.isStartAtZeroEnabled() ? 0 : minLeft));
	...
	protected float[] getMarkerPosition(Entry e, int dataSetIndex) {
		...
		PointF p = new PointF((float) (c.x + val
				* Math.cos(Math.toRadians(angle))), (float) (c.y + val
